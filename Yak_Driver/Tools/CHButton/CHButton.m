...
{
    CHButton *button = [super buttonWithType:buttonType];
    [button defaultSet];
    return button;
}
...
- (void)defaultSet
{
    ...
    self.buttonStyle = CHButtonStyleDefault;
}
...
- (void)layoutSubviews
{
    ...
    switch (self.buttonStyle) {
        case CHButtonStyleImageRightTextLeft://图片在右,文字在左
        {
            ...
            break;
        case CHButtonStyleImageUnderTextUp://图片在下,文字在上
        {
            CGRect imageViewFrame = self.imageView.frame;
            CGRect titleLabelFrame = self.titleLabel.frame;
            ...
            break;
        case CHButtonStyleImageUpTextUnder://图片在上,文字在下
        {
            CGRect imageViewFrame = self.imageView.frame;
            CGRect titleLabelFrame = self.titleLabel.frame;
            CGFloat totalHeight = imageViewFrame.size.height + self.verticalSpacing + titleLabelFrame.size.height;
            ...
            break;
        case CHButtonStyleImageLeftTextRight://图片在左,文字在右
        {
            CGRect imageViewFrame = self.imageView.frame;
            CGRect titleLabelFrame = self.titleLabel.frame;
            CGFloat totalWidth = imageViewFrame.size.width + self.horizontalSpacing + titleLabelFrame.size.width;
            
            imageViewFrame.origin.x = (self.frame.size.width - totalWidth) / 2;
            titleLabelFrame.origin.x = imageViewFrame.origin.x + imageViewFrame.size.width + self.horizontalSpacing;
